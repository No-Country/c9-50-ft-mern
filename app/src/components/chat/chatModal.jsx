...
export const Modal = () => {
  ...
  return (
    <>
      <div className='w-full grow flex flex-col pb-12'>
        ...
        <div className='flex flex-col grow w-full px-5 overflow-hidden py-5'>
          <div className='h-full'>
            <div className='overflow-auto'>
              {messages.map(({ _id, content }) => (
                <div className='max-w-xs bg-neutral-200 px-5 py-3 rounded-lg' key={_id}>
                  {content}
                </div>
              ))}
            </div>
        ...
        <form
          className='w-full flex flex-row justify-center bottom-10 gap-4'
