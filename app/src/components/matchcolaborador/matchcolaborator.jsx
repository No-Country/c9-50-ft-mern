  ...
  return (
    ...
    <div className='py-20 bg-gray-50' >
        ...
        <div className='w-full'>
            ...
            <select defaultValue={'elige'} className='w-full bg-neutral-300 rounded-2xl h-20 px-4 text-lg' name='' id=''>
              <option value="elige" disabled>Elige a tu colaborador</option>
